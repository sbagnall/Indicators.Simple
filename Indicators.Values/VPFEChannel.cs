...
{
    public class VPFEChannel : PriceRangeBarrierPropertiesBase, IOscillatingValue
    {
        ...
        public VPFEChannel(decimal MarginThreshold)
            : this(MarginThreshold, 0.0M, 0.0M, 0.0M, 0.0M)
        { }

        public VPFEChannel(decimal MarginThreshold, decimal? Lower, decimal? Mid, decimal? Upper, decimal Price)
        {
        ...
        {
            return new VPFEChannel(this.MarginThreshold, this.Lower, this.Mid, this.Upper, this.Price);
        }
    }
}
