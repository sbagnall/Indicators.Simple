...
public static class CombinatoricsUtilities
{
    ...
    /// </remarks>
    public static void GetPermutations<T>(this IList<T> list, Action<IList<T>> action, int? resultSize, bool withRepetition)
    {
        if (list == null)
    ...
    /// </remarks>
    public static void GetCombinations<T>(this IList<T> list, Action<IList<T>> action, int? resultSize, bool withRepetition)
    {
        if (list == null)
            throw new ArgumentNullException("list");
        if (action == null)
